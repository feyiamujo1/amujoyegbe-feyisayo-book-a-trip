const DateHandler = () => {
  return (
    <div className="flex items-center gap-2.5 rounded-[5px] p-4 bg-white h-[48px] active:bg-[#dadada] transition-opacity duration-300">
      <div className="flex items-center gap-2.5 ">
        ...
        <p className="text-grayedOut text-[10px] ">Departure</p>
      </div>
      <div>
        <p className="text-xs ">{"Feb 2, 2024"}</p>
      </div>
    </div>
  );
};
